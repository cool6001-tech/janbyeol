...
export const EMOTIONS = [
  { key: '기쁨', v: 0.9, e: 0.5, re: /기쁘|좋았|행복|뿌듯|웃었|웃음|설레|다행|신났|즐거|반가|성취/ },
  { key: '평온', v: 0.35, e: -0.45, re: /편안|평온|고요|잔잔|차분|나른|괜찮|놓였|덤덤/ },
  { key: '그리움', v: -0.2, e: -0.2, re: /그립|보고 싶|생각난|추억|옛|오래된 일/ },
  { key: '슬픔', v: -0.9, e: -0.3, re: /슬프|눈물|먹먹|울었|울고|울다|서럽|허전|속상|서운/ },
